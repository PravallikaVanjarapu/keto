...
const batteryDataSchema3 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5644154 },
...
const BatteryData3 = mongoose.model('BatteryData3', batteryDataSchema3);
export default BatteryData3;
