...
const batteryDataSchema6 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5691488 },
...
const BatteryData6 = mongoose.model('BatteryData6', batteryDataSchema6);

export default BatteryData6;
