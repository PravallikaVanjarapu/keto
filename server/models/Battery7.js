...
const batteryDataSchema7 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5691496 },
...
const BatteryData7 = mongoose.model('BatteryData7', batteryDataSchema7);

export default BatteryData7;