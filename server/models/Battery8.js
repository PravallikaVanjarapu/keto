...
const batteryDataSchema8 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5691499 },
...
const BatteryData8 = mongoose.model('BatteryData8', batteryDataSchema8);

export default BatteryData8;
