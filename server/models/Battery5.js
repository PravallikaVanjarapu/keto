...
const batteryDataSchema5 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5691471 },
...
const BatteryData5 = mongoose.model('BatteryData5', batteryDataSchema5);

export default BatteryData5;
