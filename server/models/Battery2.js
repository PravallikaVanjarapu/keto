...
const batteryDataSchema2 = new mongoose.Schema({
    ident: { type: String },
    servertime: { type: String },

    deviceID: { type: Number, default: 5640344 },
...
const BatteryData2 = mongoose.model('BatteryData2', batteryDataSchema2);
export default BatteryData2;
